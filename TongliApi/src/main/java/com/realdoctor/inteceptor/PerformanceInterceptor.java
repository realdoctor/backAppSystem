package com.realdoctor.inteceptor;
...
import com.easyway.business.framework.common.helper.ProfilerHelper;
...
public class PerformanceInterceptor {
    ...
    public Object Interceptor(ProceedingJoinPoint pjp) throws Throwable {
        ...
        if (ProfilerHelper.getEntry() == null) {
            ProfilerHelper.start("Invoking method: " + name);
        } else {
            ProfilerHelper.enter("Invoking method: " + name);
        }
        
        if (method.isAnnotationPresent(PerformanceClass.class)) {
            try {
        ...
        try {
            ...
            if (elapseTime > threshold) {
                ...
                logger.info(ProfilerHelper.dump());
                ProfilerHelper.reset();
            } else {
