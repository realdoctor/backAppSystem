...
import com.kanglian.healthcare.back.common.PaymentOrderItem;
...
import com.kanglian.healthcare.back.dao.GoodsOrderDao;
...
public class GoodsOrderBo extends CrudBo<GoodsOrder, GoodsOrderDao> {
    ...
    public Map<String, Object> createGoodsOrder(final PaymentOrder paymentOrder) {
        ...
        try {
            ...
            paymentLog.setPayType(goodsOrder.getPayType());// 支付类型
            paymentLog.setPayFrom(FromType.getName("6"));// 支付来源
